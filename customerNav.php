...
<script type = "text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.18/jquery-ui.min.js" type="text/javascript"/>

<script type = "text/javascript">
	function searchq()
	{
		var searchtxt = $("input[name='searchterm']").val();
		$.post("search.php", {searchVal:searchtxt},function(){
		});
	}
...
<div class="container">
    ...
    <form action="#"  method="post" class="searchform order-sm-start order-lg-last">
  <div class="form-group d-flex">
    <input type="text" name = "searchterm" class="form-control pl-3" placeholder="Search">
    <button type="submit" placeholder="" name="search" class="form-control search"><span class="fa fa-search"></span></button>
  </div>
